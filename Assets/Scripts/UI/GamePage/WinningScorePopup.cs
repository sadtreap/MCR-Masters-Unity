...
namespace MCRGame.UI
{
    public class WinningScorePopup : MonoBehaviour
    {
        ...
        public static void DisplayYakuScores(RectTransform panel, TMP_Text textPrefab, List<List<int>> yakuScores)
        {
            float spacing = 30f;
            ...
            // 각 야쿠 점수 표시
            foreach (List<int> yakuInfo in yakuScores)
            {
                Yaku yakuId = (Yaku)yakuInfo[0];
                int score = yakuInfo[1];
